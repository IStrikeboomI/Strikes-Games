...
public enum GameInfo {
    SETH_HEAD(SethHead.class,"Seth-Head",2,4,Map.of("makeMove", MakeMoveMessage.class,"drawCard", DrawCardMessage.class),Set.of(new RangedIntegerSetting("playerTimer","Player Timer",30,15,60))),
